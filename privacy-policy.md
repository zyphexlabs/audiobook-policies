...
This privacy policy explains how AudioBook ("we", "us", or "the app") collects, uses, stores, and shares user data. By using AudioBook, you agree to the practices described here.

## 1. Data we collect

We collect the following categories of data from users of the AudioBook app:

### Personal information
- **Email address** — required for account creation and authentication.
- **Name (display name)** — optional. Stored in your profile if you choose to provide it.
...
- Your contacts, calendar, photos, or videos
- Your microphone or audio recordings
- Your web browsing history
- Your installed apps
- Your race, ethnicity, religion, political beliefs, or sexual orientation
...
- **Purchase records** are retained for up to 7 years after account deletion for legal, tax, and accounting compliance.
- **Aggregate analytics** (anonymized usage statistics) may be retained indefinitely; these cannot be tied back to your account.
- All other data is deleted when you delete your account (see Section 5).

## 5. Account deletion and data rights

You can delete your account at any time using the in-app **Delete Account** option in your Profile screen. This removes your books, notes, subscription state, usage history, and locally synced data.

For details on the deletion flow and what data is retained, see our [Account Deletion Policy](https://zyphexlabs.github.io/audiobook-policies/delete-account).

If you cannot access the in-app deletion (for example, if you have lost your account credentials), you may request deletion by emailing **zyphexlabs@gmail.com** with the subject line "Account Deletion Request."
...
- File a complaint with a supervisory authority (e.g., your local data protection regulator)

To exercise any of these rights, contact us at **zyphexlabs@gmail.com**.
...
- For material changes, notify users via in-app announcement or email.
